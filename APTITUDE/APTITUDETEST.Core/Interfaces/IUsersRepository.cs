...
namespace AptitudeTest.Core.Interfaces
{
    ...
    public interface IUsersRepository
    {
        ...
        public Task<JsonResult> GetUsersExportData(string? searchQuery, int? groupId, int? collegeId, bool? Status, int? Year, string? sortField, string? sortOrder, int? currentPageIndex, int? pageSize);
